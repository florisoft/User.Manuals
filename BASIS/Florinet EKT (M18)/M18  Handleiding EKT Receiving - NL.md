...
|**5**|Een webrowser scherm/tablad wordt geopend.|
|**6**|Log in met uw EKT-mailbox account (Office365).|
|**7**|U krijgt nu een vraag om Florisoft toegang te geven tot de volgende instellingen:<br>- Toegang onderhouden tot gegevens waardoor u Florisfot toegang hebt verleend<br>- Toegang tot het verzenden van e-mails vanuit uw postvak<br>- Je profiel lezen<br>- E-mail verzenden als jou<br>- Je e-mail lezen<br>- lees- en schrijftoegang tot je e-mail<Br><br>**Als u hiertoe bereid bent kan u ok "Ja" drukken**<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src=".Handleiding standaard EKT-berichten Florisoft/media/image35.png"></details>|
