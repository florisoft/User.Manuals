...
|Step#|Explanation|
|:--|:--|
|**1**|Assuming you are on the same screen as the previous listicle's step 5, check the checkboxes listed earlier. Now press on the '*Changes to*' button (#6) this should open a new dialog window. <br> <details><summary>Click here to reveal the image</summary><img src="Media/image3.png"></details>|
...
As a supplier it is possible to make credit reasons in Florisoft. Credit reasons are reasons as to why a customer submits a credit request. These credit reasons will be visible when making a credit request forom the webshop. Examples of credit reasons are broken products, wrongly supplied amount. 
