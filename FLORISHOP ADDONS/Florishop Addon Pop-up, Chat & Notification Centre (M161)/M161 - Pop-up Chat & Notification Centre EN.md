...
|**5**|If you want to always display a notification, check **Message never expires**. No end date is needed.<br><br>In **Valid from / Valid to date**, specify the date range during which the notification should be shown. Outside this period, the notification will not appear.<br><details><summary><b>Click here for an example!</b></summary><img src=".Pop-up Chat & Notification Centre NL/image12.png"></details>|
