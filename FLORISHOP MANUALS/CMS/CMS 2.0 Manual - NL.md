...
Bouw een dynamisch formulier en verstuur de ingevulde gegevens naar één of meerdere e-mailadressen. Stel daarnaast een automatisch bevestigingsbericht in voor de afzender. Voorkom spam door gebruik te maken van reCAPTCHA. Daarnaast is er een optie beschikbaar genaamd Botpreventiemodus, waarbij een verborgen inputveld wordt toegevoegd om bots te detecteren en tegen te gaan. De gegevens van een nieuwe klant kunnen optioneel worden meegestuurd in een Excel-bestand, zodat deze eenvoudig te importeren zijn in de backoffice. 

*Volg onderstaande stappen:*

|Stap|Uitleg|
|:--|:--|
|**1**|In het voorbeeld zijn wij bezig op een contact [pagina](#pagina) en willen hier een formulier gaan plaatsen. Dit doen wij door in de [Navigator](#navigator) op het '+'-icoon achter het [Panel](#panel) component (1) te klikken. Vervolgens wordt het [Componenten dialoog](#componenten-dialoog) geopend. <details><summary><b>Klik hier voor de voorbeeldafbeelding</b></summary><img src="media/52.1.png"></details>|
|**2**|In dit dialoog navigeer je via de categorie 'Formulier' (2) en voeg je via het '+'-icoon het Formulier component toe aan je pagina (3).<details><summary><b>Klik hier voor de voorbeeldafbeelding</b></summary><img src="media/52.2.png"></details>|
|**3**|Het Formulier component is nu zichtbaar (4) in de Navigator en kunnen we vervolgens gelijk bewerken via de algemene instellingen tab (5). Via 'Vertalingen bewerken' (6) kunnen tekstvelden voor meerdere talen worden ingevuld. Hier lees je meer over bij [Vertalingen](#vertalingen). Vul het E-mail onderwerp in van je formulier (7). Dit is de onderwerpregel die het emailadres ontvangt die je invult onder 'Ontvangers' (8). Via de toevoegknop (9) kun je meerdere emailadressen invoeren. Er zullen altijd bots zijn die op de loer liggen om spam te versturen via jouw formulier. Dit kun je voor een groot deel tegen gaan door de Bot preventiemodus (10) op de volgende opties te zetten:<br><br>**Geheime invoerveld**: Zet een leeg invoervelt in jouw formulier die voor niemand zichtbaar is en dus niet ingevuld kan worden. Wanneer deze wel wordt ingevuld (door een Bot), zal het formulier niet verzonden worden.<br>**Tijd gebaseerd**: Bots versturen formulieren binnen slechts enkele milliseconden. Als je formulier binnen 3 seconden (instelbaar) wordt ingevuld, zal het formulier niet worden verzonden. Als je een eigen Google account hebt is het ook mogelijk om ReCAPTCHA (11) in te schakelen op je shop. Onderstaand vindt je de stappen die hiervoor nodig zijn:<br><br>**ReCAPTCHA configureren stappenplan**<br><br>1. Login op jullie Google Account<br>2. Als het Google Account nog geen Project heeft, kan je op deze pagina een aanmaken: https://console.cloud.google.com/projectcreate<br>3. Maak op de pagina van Google een nieuwe ReCAPTCHA instantie aan (https://www.google.com/recaptcha/admin/create)<br>3a. Vul voor 'Label' een handige identificeerbare naam in, bijv: [bedrijfsnaam] ReCAPTCHA<br>3b. Laat de ReCAPTCHA type staan op 'Score based (v3) - Verify requests with a score', deze is ondersteund op de shop.<br>3c. Voer bij 'Domains' in: [jouw domein].nl<br>3d. Kies het net-aangemaakte Project, of een al-bestaand Project<br>3e. Submit<br>4. Op de volgende pagina zie je twee keys, deze zijn belangrijk. Sla deze op. Dit zijn de Site Key en de Secret Key.<br>5. Optioneel: na het opslaan van de keys, doorklikken naar 'View in Cloud Console', dit is de beheer omgeving voor de ReCAPTCHA instantie.<br>6. Op de shop, configureer de volgende drie webshopsettings<br>6a. RECAPTCHAACTIEF --> zet aan<br>6b. RECAPTCHASITEKEY --> vul hier de Site key van de ReCAPTCHA instantie<br>6c. RECAPTCHASECRETKEY --> vul hier de Secret key van de ReCAPTCHA instantie<br>7. Na het instellen van de webshopsettings, restart de shop.<br>8. In het CMS Edit modus, bij de instellingen van een formulier, zet 'Gebruik ReCAPTCHA' aan. Doe dit voor elke formulier waarvoor ReCAPTCHA gebruikt moet worden.<br>9. Sla CMS op / publish en Refresh pagina<br>10. Google ReCAPTCHA is nu actief, bij het versturen van de formulieren controleert Google nu het gedrag, browser, en andere technische details om een score te berekenen. Is deze score te laag dan wordt het versturen van het formulier afgebroken, krijgt de gebruiker een foutmelding en wordt er niet meer gemaild.<br>NB1: Deze variant van ReCAPTCHA gebruikt dus niet de Checkbox/Checkmark waarop je moet klikken, maar berekent op de achtergrond automatisch een score.<br>NB2: Pagina's met formulieren krijgen rechtsbeneden nu een 'beveiligd met ReCAPTCHA'-banner.<br><br>Formulieren kunnen ook worden verzonden met behulp van een XSL-template naar een e-mailadres naar keuze. Zorg er in dat geval voor dat de SMTP-instellingen van de webshop correct zijn geconfigureerd en dat er een XSL-template (12) beschikbaar is voor het actieve thema. Hetzelfde geldt voor de Autoreply XSL (13). Lees hier (14) meer over het gebruik van [Component Styles](#component-styles).<details><summary><b>Klik hier voor de voorbeeldafbeelding</b></summary><img src="media/52.3.png"></details>|
|**4**|Bevestigingsopties (15) kunnen ook gemakkelijk worden ingesteld. Via 'Bevestigingsfeedback' (16) kun je aangeven of je na het versturen van het formulier een 'Dankjewel'-bericht wilt tonen via 'ShowDialog', of dat je de bezoeker wilt doorsturen naar een [CMSPage](#pagina). Wanneer 'CMSPage' is geselecteerd kun je via **CMS Page** (17) een pagina selecteren. Kies je voor 'ShowDialog', dan kun je vervolgens een titel (18) en een bericht (19) invullen die getoond zal worden aan de gebruiker wanneer het formulier succesvol is verstuurd.<details><summary><b>Klik hier voor de voorbeeldafbeelding</b></summary><img src="media/52.4.png"></details>|
|**5**|'Mail naar afzender' (20) vul je in wanneer je in jouw [Email input component](#email-input) 'Stuur bevestigingsmail' hebt ingeschakeld. Na het versturen van het formulier zal de afzender via de mail deze bevestiging ontvangen in zijn/haar mailbox. Vul een titel (21) in voor in het mailbericht. Vervolgens kun je een bericht (22) typen. In dit veld kan er gebruik worden gemaakt van placeholders zoals **{{first_name}}** of **{{company_name}}**. Op deze manier kun je het bevestigingsbericht meer personaliseren. Zorg er wel voor dat de Inputnames overeen komen met de desbetreffende [invoervelden](#tekst-input). Wel is het aan te raden om dit duidelijk te communiceren in jouw formulier door middel van een [checkbox](#checkbox) met de tekst: *Ik ga ermee akkoord dat mijn gegevens gebruikt mogen worden voor de verwerking van mijn verzoek.* i.v.m. privacy wetgeving. Bepaal ook het onderwerpregel van je mail (23). <details><summary><b>Klik hier voor de voorbeeldafbeelding</b></summary><img src="media/52.5.png"></details>|
|**6**|Via de [styling-tab](#styling) kunnen er kleuren en andere leuke visuele effecten worden ingesteld op het uiterlijk van het formulier.<details><summary><b>Klik hier voor de voorbeeldafbeelding</b></summary><img src="media/52.6.png"></details>|
|**7**|Via de tab '[Geavanceerd](#5-geavanceerd)' (25) kunnen er nog technische wijzigingen worden gemaakt omtrent het formulier. Zo kan het formulier via 'ExcelAsMailAttachment' worden opgeslagen (26) als Excel-bestand zodat je deze vanuit de email-bijlagen kunt downloaden. De andere twee opties 'Database' en 'ExcelFile' zullen worden opgeslagen aan de server en data-kant van jouw shop. De tijd (27) van de eerder uitgelegde 'Tijd gebaseerd'-optie van de Bot preventiemodus kan hier worden ingesteld. De waardes zijn instelbaar per seconde. optioneel is het mogelijk om het formulier een naam (28) te geven wat ook netjes zichtbaar zal worden in het [Form-tracking scherm](#form-tracking) en kun je ook hier net als in de algemene instellingen een URL (29) instellen nadat je het formulier hebt verstuurd. Wij raden aan om slechts een van deze twee opties te gebruiken. Stel in om de invoer velden leeg te maken (30) na het versturen van het formulier, of geef aan dat het formulier in testmodus zit via Dummy (31). De overige instellingen vindt je terug bij '[Geavanceerd](#5-geavanceerd)'.<details><summary><b>Klik hier voor de voorbeeldafbeelding</b></summary><img src="media/52.7.png"></details>|
|**8**|Maak via de [Zichtbaarheid-tab](#zichtbaarheid) het formulier zichtbaar voor specifieke gebruikers.<details><summary><b>Klik hier voor de voorbeeldafbeelding</b></summary><img src="media/52.8.png"></details>|
