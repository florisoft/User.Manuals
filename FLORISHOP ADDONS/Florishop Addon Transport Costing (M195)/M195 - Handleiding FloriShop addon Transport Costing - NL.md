...
|Stap|Uitleg|
|:--|:--|
|**1**|Klik op het kalender icoon links bovenaan het scherm, dit laat de onderstaande wizard zien.<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image1.png"></details>|
|**2**|Na het kiezen van een vertrekdag krijgt u de opties bezorgen of afhale n te zien.<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image2.png"></details>|

## Order nummers aan maken
...
|**2**|Klik op de *toevoegen* knop (+), dit open een nieuw scherm voor het aan maken van een nieuw order nummer.<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image3.png"></details>|
|**3**|Vul het order nummer in. **Belangrijk om te onthouden**: *de order nummer kan niet langer dan 4 karakters lang zijn.*
|**4**|Vul een beschrijving in het omschrijving veld.<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image3.png"></details>|
...
|**6**|Klik op de toevoegen knop om een nieuw order nummer toe te voegen. Een nieuw scherm zou nu tevoorschijn moeten komen<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image3.png"></details>|
...
|Stap|Uitleg|
|:--|:--|
|**1**|Open het constanten scherm en navigeer naar het onderstaande pad: <br> **Organen**→**Debiteur gegevens**→**Debiteuren**<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image4.png"></details>|
...
|**4**|In dit tabje past u de volgende instellingen aan:<br>- **Moet een vertrekdag kiezen**: vink deze checkbox aan.<br> -**Vertrekdag volgens**: selecteer hier of de geldige vertrekdag volgens de debiteurs vertrekdagen, toegankelijk voorraad of transportroute van het systeem is.<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image4.png"></details>|
|**5**|Om een order nummer toe te voegen navigeert u naar het mapje *Internet toegang* een submapje van de map *Internet*|
|**6**|Vul hier het desbtreffende order nummer in (#3)<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image4.png"></details>|
...
|Stap|Uitleg|
|:--|:--|
|**1**|Open het constanten scherm en navigeer naar onderstaande pad:<br>**Systeem**→**Order nummers**→**Order nummers**<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image8.png"></details>|
...
<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image9.png"></details>
...
<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src="Media_NL/image10.png"></details>
