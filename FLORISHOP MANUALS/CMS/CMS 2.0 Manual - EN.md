...
| **2** | The **Carousel** component is now visible in the [Navigator](#navigator) (3) and in the Editor. In this example, we have added multiple [Panels](#panel) to the Carousel and given each one its own [name](#identificatienaam). Via the **[General settings](#algemene-instellingen)** tab (4), you can configure the following options:<br><br>**Lazy load slides** (5): When enabled, slides are only loaded when they become visible.<br><br>**Swiping** (6): Enable this option to navigate through the slides using a swipe gesture.<br><br>**Style** (7): Select a style for the chevrons (navigation arrows).<br><br>**Chevron position** (8): Determine where the navigation arrows are displayed. **Overlay** places the arrows over the slide, while **Indent** places the arrows next to the Carousel.<br><br>**Chevron** (9): Enable or disable this option to show or hide the navigation arrows.<br><br>**Pagination** (10): Displays pagination dots below the Carousel to indicate the number of slides and the current position.<br><br>**Loop** (11): Enable or disable this option to make the Carousel loop continuously. After the last slide, the first slide will be shown again.<br><br>**Autoplay - interval in seconds** (12): Specify how many seconds a slide is displayed before the next slide is shown.<br><br>**Autoplay** (13): Enable or disable automatic playback of the slides.<br><br>**Height mode** (14): Determine how the height of the slides is handled. **Auto height** automatically adjusts the height when the next slide has a different height. **Auto stretch** ensures that all slides have the same height.<br><br>**Space between slides** (15): Set the number of pixels for the space between the slides.<details><summary><b>Click here for the example image</b></summary><img src="media/40.2.png"></details> |
| **3** | Via the **[Styling](#3-styling)** tab (16), you can configure the following options:<br><br>**[Height](#hoogtebreedte)** (17): Set the height of the Carousel.<br><br>**Column alignment** (18): Align the slides to the left, right, or center.<br><br>**[Slide width](#hoogtebreedte)** (19): Set the width of each slide.<br><br>**[Slide content width](#hoogtebreedte)** (20): Set the width of the content within each slide.<br><br>**Visible columns (desktop)** (21): Specify how many slides are displayed simultaneously on desktop devices.<br><br>**Visible columns (tablet)** (22): Specify how many slides are displayed simultaneously on tablets.<br><br>**Visible columns (mobile)** (23): Specify how many slides are displayed simultaneously on mobile devices.<details><summary><b>Click here for the example image</b></summary><img src="media/40.3.png"></details> |
