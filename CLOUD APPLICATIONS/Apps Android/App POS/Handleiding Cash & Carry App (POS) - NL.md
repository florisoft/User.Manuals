...
|**20**|In dit scherm ziet u meer informatie over de partij, zoals de fustcode en het fustaantal:<br>**1.** U kunt de prijs verhogen of verlagen<br>**2.** Het aantal fusten verhogen of verlagen<br>**3.** De verkoopeenheid verhogen of verlagen.<br><br>Of een prijs onder de inkoopprijs mag worden opgeslagen, hangt af van de ingestelde policy. Bij `AllowWithStockItemMark` is dit alleen toegestaan voor partijen met een markering die is opgenomen in `AllowedStockItemMarksForSellingBelowPurchasePrice`. Anders blijft de oorspronkelijke prijs staan en verschijnt een waarschuwing.<details><summary>**Klik hier om de voorbeeld afbeelding te zien!**</summary><img src="Cash & Carry App/21.jpg" height=350px></details>|
