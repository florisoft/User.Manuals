...
| **7** | Het uitklapvenster **Toon alles** (26) bevat de optie **Toon alles-linktekst** (27). Hiermee kun je een eigen tekst voor de **Toon alles**-knop instellen. Daarnaast kun je een eigen URL invoeren (28). Laat je deze velden leeg, dan toont het component automatisch een **Toon alles**-link die naar de bijbehorende voorraad verwijst.<details><summary><b>Klik hier voor de voorbeeldafbeelding</b></summary><img src="media/44.7.png"></details> |
