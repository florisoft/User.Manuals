...
|**7**|Enter the Cloud server URL in textbox 1.<br>For the second textbox, you will need to select a release channel. We have two options:<Br><Br>**1. latest**: This will use the app version that is downloaded with your current main backoffice installation.<br><br>**2. update**: This channel provides you with the app version that is downloaded with your update client, enabling you to test new app versions compatible with the newer release on the update client.<br><br>In this field, you will need to enter either "latest" or "update". Generally, the latest channel will be used.<br>As for the third menu item, select the app's display language.<br>**Make sure to save the changes made to the settings**.<details><summary><b>Click here for the example image!</b></summary><img src="Media/Installatie Hub-App/image5.png"></details>|
...
|**5**|Enter the Cloud server URL in textbox 1.<br>For the second textbox, you will need to select a release channel. We have two options:<Br><Br>**1. latest**: This will use the app version that is downloaded with your current main backoffice installation.<br><br>**2. update**: This channel provides you with the app version that is downloaded with your update client, enabling you to test new app versions compatible with the newer release on the update client.<br><br>In this field, you will need to enter either "latest" or "update". Generally, the latest channel will be used.<br>As for the third menu item, select the app's display language.|
