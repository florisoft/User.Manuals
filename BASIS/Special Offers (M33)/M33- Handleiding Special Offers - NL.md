...
|**4**|Wanneer de gekozen debiteur nog geen aanbiedingen heeft, zie je het onderstaande venster. Klik op ‘Ja’ om een nieuwe aanbiedingslijst (Special Offer) te maken.<details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src=".Handleiding aanbiedingen mail Florisoft/media/image3.png"></details>|
...
|**11**|Gebruik de pijltoetsen op het toetsenbord (of de muis) om naar het volgende product te gaan en druk op de spatiebalk om het te selecteren.|
...
|**19**|Selecteer uit de onderstaande tabel artikelen met de spatiebalk, stel vervolgens een opslag in de bovenkant van het scherm. Bevestig de instellingen door op de **Ok** knop te drukken. <details><summary><b>Klik hier voor uw voorbeeld afbeelding</b></summary><img src=".Handleiding aanbiedingen mail Florisoft/media/image13.png"></details>|
...
## Maken profielklant aanbieding

|Stap|Uitleg|
|:-:|:--|
|**1**|Open het constantenscherm en maak een *Profiel Categorie* aan onder:<br>**Organen→Debiteurgegevens→Profiel categorie**|
|**2**|Maak nu een debiteur profiel aan die valt in de zojuist aangemaakte profiel categorie.<br>**Organen→Debiteur gegevens→Profielen**|
|**3**||
|**4**||
|**5**||
|**6**||
