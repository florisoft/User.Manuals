...
Use this screen to easily upload your own images and video files and then use them on your [CMS pages](#page).
...
| **6** | You can then save the changes you have made (31) or cancel by navigating back to the selection screen (32). In this example, we save the changes (31).<details><summary><b>Click here for the example image</b></summary><img src="media/14.6.png"></details> |
